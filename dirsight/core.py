"""DIRSIGHT core — Analyze web content-discovery output (ffuf/gobuster) into ranked endpoints."""
...
RULES = [
    ("DIR-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("DIR-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("DIR-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
