...
[![PyPI](https://img.shields.io/pypi/v/cognis-dirsight.svg)](https://pypi.org/project/cognis-dirsight/)
[![CI](https://github.com/cognis-digital/dirsight/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/dirsight/actions)
...
DIRSIGHT exists for one job — analyze web content-discovery output (ffuf/gobuster) into ranked endpoints — and does it without a SaaS bill or heavyweight setup.
...
```bash
dirsight --version
dirsight scan .                      # scan the current project
dirsight scan . --format json
dirsight scan . --fail-on high       # non-zero exit for CI gates
dirsight mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **ffuf**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`dirsight` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
