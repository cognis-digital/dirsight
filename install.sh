#!/usr/bin/env sh
# Universal installer for dirsight. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/dirsight.git"
echo "Installing dirsight ..."
